...
export default function SolutionSection() {
  return (
    <section className="red-section px-4 py-8 max-w-5xl mx-auto relative overflow-hidden">
      <div className="slide-up">
        ...
        <div className="space-y-4 leading-relaxed">
          ...
          {/* Espace réduit et styles unifiés */}
          ...
          <div className="relative bg-white/5 rounded-2xl p-4 border border-white/10 text-center">
            <p className="mb-3 text-sm text-gray-300 italic">Quand une situation le dépasse, il te notifie. Ex :</p>
            
            <div className="bg-black border border-white/30 rounded-xl p-4 italic text-sm text-white mb-4 shadow-lg inline-block w-full">
            ...
            <img
              src="/image.jpeg"
              alt="MAVA Dashboard"
              className="w-28 h-28 md:w-32 md:h-32 mx-auto object-contain floating-image drop-shadow-2xl"
            />
          </div>
        </div>
      </div>
